...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="subtitle">
                Sistema de pareamento automático com
                prioridade em evitar conflitos de reino,
                esquadrão e elemento.
            </div>
            ...
            <form method="post">
                ...
                <textarea
                    id="lista"
                    name="lista"
                    placeholder="Cole aqui a lista inteira..."
                ...
                <div class="actions">
                    ...
                    <button class="btn-secondary" type="button" onclick="copiarResultado()">
                        📋 Copiar resultado
                    </button>

                    <button class="btn-tertiary" type="button" onclick="limparTudo()">
                        🧹 Limpar
                    </button>
                </div>
            </form>
            ...
            <div class="tips">
                ...
                1. Evitar mesmo reino.<br>
                2. Evitar mesmo esquadrão.<br>
                3. Evitar mesmo elemento.
            </div>
            ...
            <div class="footer">
                preto no pano, escarlate no impacto,
                azul e roxo flutuando no caos.
            </div>
